...
void open_nb_socket(struct mbedtls_context *ctx, const char *hostname,
                    const char *port, const char *ca_file);
...
void open_nb_socket(struct mbedtls_context *ctx, const char *hostname,
  ...
  mbedtls_ssl_set_bio(ssl_ctx, net_ctx, mbedtls_net_send, mbedtls_net_recv,
                      nullptr);
